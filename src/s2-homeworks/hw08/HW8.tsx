...
const initialPeople: UserType[] = [
    ...
    {_id: 0, name: 'Чжун Ли', age: 3000},
    {_id: 1, name: 'Нахида', age: 500},
    {_id: 2, name: 'Е Лань', age: 25},
    {_id: 3, name: 'Ху Тао', age: 14},
    {_id: 4, name: 'Барбара', age: 14},
    {_id: 5, name: 'Райдэн', age: 1550},
]
